...
### Planned for v0.1.0 (Sprint 0 → Sprint 1)
...
- Rewrite `docs/PLAN.md` as an awsbnkctl sprint roadmap; author `docs/prd/00-OVERVIEW.md` and `docs/prd/01-EKS-CLUSTER.md` (SR-IOV-on-self-managed-nodes decision).
