...
Account: 123456789012, ap-southeast-2, profile Users-123456789012.
...
7. Verify clean teardown via tag-discovery audit:
   ```
   aws ec2 describe-instances --filters Name=tag:awsbnkctl:cluster,Values=syd-tracer --profile Users-123456789012 --region ap-southeast-2
   aws ec2 describe-vpcs --filters Name=tag:awsbnkctl:cluster,Values=syd-tracer --profile Users-123456789012 --region ap-southeast-2
   aws eks describe-cluster --name syd-tracer --profile Users-123456789012 --region ap-southeast-2
   ```
...
# AWS prereqs:
export AWS_PROFILE=Users-123456789012
aws sso login --profile Users-123456789012       # only if SSO expired
```
