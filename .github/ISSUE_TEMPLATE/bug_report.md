---
name: Bug report
about: Something awsbnkctl does that it shouldn't, or doesn't do that it should
...
<!--
  ...
  Examples that don't help much:
    - "awsbnkctl is broken" — too vague to act on.
...
<!--
  - awsbnkctl version: `awsbnkctl version` output (must be present)
  - OS / arch: e.g. Linux x86_64, macOS arm64, Windows x86_64
  - AWS region: e.g. ca-tor, us-south
